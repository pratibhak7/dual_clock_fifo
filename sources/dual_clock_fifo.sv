// Reference implementation for dual_clock_fifo (use in sources/ on golden branch).
...
logic [PTR:0] wr_ptr_bin, rd_ptr_bin;
logic [PTR:0] wr_ptr_gray, rd_ptr_gray;
...
assign full  = (wr_ptr_gray == {~rd_ptr_sync2[PTR:PTR-1], rd_ptr_sync2[PTR-2:0]});
